...
<cfif isDefined("url.cat")>
	<cfquery name="GetSection1" datasource="#memberDSN#" maxrows="1">
		Select value_4
	...
	<cfquery name="GetSection2" datasource="#memberDSN#">
		Select value_1
		From sl_general_purpose
		Where name = '#url.name#' and 
			<cfif url.lid GT "">
			...
			<cfelse>
				leagueid is null and associd = #application.aid#
			</cfif> and value_4 = '#NumberFormat(newOrder1,  "09")#'
	</cfquery>
	<cfquery name="UpdateOrder1" datasource="#memberDSN#">
	...
	<cfquery name="UpdateOrder2" datasource="#memberDSN#">
		Update sl_general_purpose
		...
		Where name = '#url.name#' and 
			...
			<cfelse>
				leagueid is null and associd = #application.aid#
			</cfif> and value_1 = '#GetSection2.value_1#'
	</cfquery>
<cfelseif isDefined("url.nid")>
	<cfquery name="GetNews1" datasource="#memberDSN#" maxrows="1">
	...
	<cfquery name="GetNews2" datasource="#memberDSN#">
		Select newsid
		From sl_news
		Where category = '#GetNews1.category#' and 
			<cfif url.lid GT "">
				leagueid = #url.lid#
			<cfelse>
				leagueid is null and associd = #application.aid#
			</cfif> and sortorder = #newOrder1#
	</cfquery>
	<cfquery name="UpdateOrder1" datasource="#memberDSN#">
		Update sl_news
...
<cfelseif isDefined("url.did")>
	<cfquery name="GetDiv1" datasource="#memberDSN#" maxrows="1">
	...
	<cfquery name="GetDiv2" datasource="#memberDSN#">
		Select divid
		From sl_division
...
<cfelseif isDefined("url.calid")>
	<cfquery name="GetCal1" datasource="#memberDSN#" maxrows="1">
	...
	<cfquery name="GetCal2" datasource="#memberDSN#">
		Select calendarid
		From sl_calendar
		Where 
			<cfif url.lid GT "">
