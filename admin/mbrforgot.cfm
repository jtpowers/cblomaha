...
Here's your login information for #application.sl_url#:
...
<form action="mbrforgot.cfm" method="post" name="loginform">
<table width="100%">
	<tr>
	...
	<tr>
		<td valign="top" align="center">
			...
			<table border="0" cellspacing="0" cellpadding="3">
				...
				<tr><td colspan="2">
					<div align="center">
						<a href="mbrlogin.cfm" class="linksm">Return to Login</a>
					</div>
				</td></tr>
			</table>
			</td></tr></table>
