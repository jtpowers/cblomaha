...
<cfinclude template="#rootdir#ssi/header_empty.cfm">
	...
	<div class="row">
		...
		<div class="col-sm-12 col-md-4 col-lg-3 titlemain">
			<form action="gameresults2.cfm?lid=<cfoutput>#url.lid#</cfoutput>" method="post" class="form-horizontal">
...
<tr><td align="center">
<cfif getGamesPlayed.RecordCount GT 0>
	<table class="table table-responsive table-condensed table-bordered"><!--T2-->
		<cfset hDiv = "">
		<cfset holdLevel = "">
		<cfset levelcount = 1>
