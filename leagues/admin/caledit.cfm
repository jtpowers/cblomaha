...
<tr><td align="center">
	<cfform action="caledit.cfm?lid=#url.lid#&calid=#url.calid#" method="post">
	<cfoutput>
		...
		<table border="1" cellspacing="0" cellpadding="3">
			...
			<table cellpadding="2" cellspacing="0">
				<tr>
					...
					<td><cfinput name="u_calname" type="text" value="#form.u_calname#" required="yes" message="Calendar Name is required." class="small"></td>
				</tr>
			</table>
			</td></tr>
		</table>
