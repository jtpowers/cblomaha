...
<cfquery name="getFiles" datasource="#memberDSN#">
	...
	From sl_file
	Where leagueid = #url.lid# and FileType = '#form.filetype#'
	Order by FileName
</cfquery>
...
<form action="fileupload.cfm?lid=<cfoutput>#url.lid#</cfoutput>" method="post">
<tr>
	<td valign="top">
...
<tr>
	<td valign="top">
		<cfoutput>
		<a href="javascript:fPopWindow('uploadfile.cfm?lid=#url.lid#&filetype=#form.filetype#', 'custom','500','200','toolbar: 0','status: 1','location: 0','menubar: 0','scrollbars: 0')" class="linksm">Upload File/Image</a>
		</cfoutput>
		...
		<cfoutput query="getFiles">
			...
			<tr bgcolor="#rColor#">
				<td>
					<a href="#rootdir#/#form.filetype#/#FileName#" target="_blank" class="small">#FileName#</a>
				</td>
				<td class="small">
					#FileSize#
				</td>
