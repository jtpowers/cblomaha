...
<cfif action EQ "updateNews">
	...
	<cfif form.s_display EQ 1 and form.s_sort EQ "">
		<cfquery name="GetNextSort" datasource="#application.memberDSN#">
			SELECT Max(SortOrder) as lastsort
			FROM sl_news
			Where Category = '#form.s_cat#' and DisplayFlag = 1 and associd = #application.aid# and leagueid = #url.lid#
		</cfquery>
	...
	<cfquery name="UpdateNews" datasource="#application.memberDSN#">
		Update sl_news
		Set Title = '#s_title#',
...
<cfelseif action EQ "addNews">
	...
	<cfquery name="AddNews" datasource="#application.memberDSN#">
		Insert Into sl_news (Title, ShortTitle, CreateDate, Body, AssocID, Category, SortOrder, Attachment, AttachmentTitle, DisplayFlag, NewsType, NewsURL, LinkTarget, LeagueID)
		Values('#s_title#', 
	...
	<cfquery name="GetLastNews" datasource="#application.memberDSN#">
...
<cfelseif action EQ "deleteNews">
	<cfquery name="DeleteNews" datasource="#application.memberDSN#">
		Delete From sl_news
		where  NewsID = #url.nid#
	</cfquery>
	<cfset done = 1>
...
<cfquery name="getCategories" datasource="#application.memberDSN#">
	...
	Where name = 'MenuSection' and AssocID = #application.aid# and LeagueID = #url.lid#
	Order by Value_4
</cfquery>
<cfparam name="url.cat" default="#getCategories.Value_1#">
<cfparam name="url.nid" default="">

<cfdirectory action="list" directory="#application.leagueDir#\files\#application.aid#\#url.lid#" name="filelist">
...
<cfset pageTitle = "Website Section Page Edit">
...
<tr><td align="center">
	<table class="table table-condensed no-border"><tr><td valign="top" align="center">
		<cfform action="sectionitemedit.cfm?nid=#url.nid#&lid=#url.lid#" method="post" name="NewsForm">
