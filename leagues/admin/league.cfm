...
<cfdirectory action="list" directory="#leagueDir#\images\#url.lid#" name="imagelist">
...
<form action="league.cfm?lid=<cfoutput>#url.lid#</cfoutput>" method="post">
<table>
	<tr>
			...
			<cfif #GetLeague.LeagueLogo# NEQ "">
				<tr>
					...
					<td bgcolor="<cfoutput>#GetLeague.HeaderColor#</cfoutput>">
						<cfoutput><img src="#rootDir#images/#url.lid#/#GetLeague.LeagueLogo#"></cfoutput>
					</td>
				</tr>
			</cfif>
				<!--- <tr>
