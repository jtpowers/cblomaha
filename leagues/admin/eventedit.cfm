...
<cfform action="event-#action#.cfm?lid=#url.lid#&calid=#url.calid#" method="post">
	...
	<table border="0" cellpadding="5" bordercolorlight="black" bordercolordark="white" cellspacing="0" width="100%">
		...
		<tr> 
			<td valign="TOP" class="smallb">*Date:</td>
	      	<td valign="TOP">
				<input type="text" name="eventDate" value="<cfoutput>#DateFormat(evdate, "mm/dd/yy")#</cfoutput>" size="10" class="small">
	      	</td>
	    </tr>
		<tr> 
			<td valign="TOP" class="smallb">Start Time:</td>
	      	<td valign="TOP">
