...
<form action="sl_forgot.cfm?lid=<cfoutput>#url.lid#</cfoutput>" method="post" name="loginform">
<table width="100%">
	<tr>
	...
	<tr>
		<td valign="top" align="center">
			...
			<table border="0" cellspacing="0" cellpadding="3">
				...
				<tr><td colspan="2">
					<div align="center">
						<a href="sl_login.cfm?lid=<cfoutput>#url.lid#</cfoutput>" class="linksm">Return to Login</a>
					</div>
				</td></tr>
			</table>
			</td></tr></table>
